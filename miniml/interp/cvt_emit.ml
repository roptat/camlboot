# 16 "../../ocaml-src/tools/cvt_emit.mll"
...
and __ocaml_lex_main_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 39 "../../ocaml-src/tools/cvt_emit.mll"
...
# 138 "cvt_emit.ml"
  ...
  | 1 ->
# 46 "../../ocaml-src/tools/cvt_emit.mll"
        ( print_string "`"; main lexbuf )
# 143 "cvt_emit.ml"

  | 2 ->
# 47 "../../ocaml-src/tools/cvt_emit.mll"
        ( () )
# 148 "cvt_emit.ml"

  | 3 ->
# 48 "../../ocaml-src/tools/cvt_emit.mll"
...
and __ocaml_lex_command_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 51 "../../ocaml-src/tools/cvt_emit.mll"
        ( () )
# 165 "cvt_emit.ml"

  | 1 ->
# 52 "../../ocaml-src/tools/cvt_emit.mll"
...
# 173 "cvt_emit.ml"
  ...
  | 2 ->
# 57 "../../ocaml-src/tools/cvt_emit.mll"
...
# 181 "cvt_emit.ml"
  ...
  | 3 ->
# 65 "../../ocaml-src/tools/cvt_emit.mll"
        ( let s = Lexing.lexeme lexbuf in
          add_semicolon();
...
# 201 "cvt_emit.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf;
      __ocaml_lex_command_rec lexbuf __ocaml_lex_state

;;

# 82 "../../ocaml-src/tools/cvt_emit.mll"
